...
<div class="container-fluid">
    ...
    <form:form action="/product-detail/update" method="post" modelAttribute="productDetail">
        <div class="row">
            <div class="col-6">
                <div class="mb-3">
                    <label>ID:</label>
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-warning" onclick="return confirm('Do you want to create this product detail?')">Update</button>
